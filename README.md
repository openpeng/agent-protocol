...
3. **Builtin Tools** - 标准工具系统（llm_chat、read_file、bash 等）
4. **Subagent System** - 多子 Agent 组合机制
5. **Deployment Targets** - 跨平台部署适配
...
| [specs/subagent-system.md](./specs/subagent-system.md) | 子 Agent 机制规范 |
| [specs/mcp-integration.md](./specs/mcp-integration.md) | MCP 集成规范 |
| [specs/deployment-targets.md](./specs/deployment-targets.md) | 部署目标适配规范 |
...
| [schemas/tool.schema.json](./schemas/tool.schema.json) | 工具定义 JSON Schema |
...
- **agent-deploy** - Agent 运行时、Market 工具、MCP Server
  - Repository: https://github.com/openpeng/agent-deploy
  - 支持 agent.json v3、Pipeline 执行、9+ 部署目标
